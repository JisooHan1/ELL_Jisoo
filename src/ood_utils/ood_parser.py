...
def parse_args():
    ...
    parser.add_argument("--path", type=str, required=False, help="path to the trained model")  # For ood_test.py
    parser.add_argument("--batch_size", type=int, required=True, help="batch size")
    parser.add_argument("--id_dataset", type=str, required=True, help="id dataset")
    parser.add_argument("--oe_dataset", type=str, required=False, help="oe dataset")  # For oe based training method
